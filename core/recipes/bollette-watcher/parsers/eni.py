"""Parser Eni — bollette Eni Plenitude / Eni Gas e Luce formato standard 2024-2026."""
...
_MATCH_TERMS = ['eni plenitude', 'eni gas e luce', 'plenitude']


class EniParser(BaseBollettaParser):
    NAME = "eni"
    FORNITORE_DISPLAY = "Eni Plenitude / Eni Gas e Luce"
    TIPO = "gas"
    ...
    def parse(self, text: str) -> ParsedBolletta:
        ...
        if (m := _RX_KWH.search(text)):
            ...
            if not result.tipo or result.tipo == "gas":
                result.tipo = "luce"
