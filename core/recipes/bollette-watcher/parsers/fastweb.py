"""Parser Fastweb — bollette Fastweb formato standard 2024-2026."""
...
_MATCH_TERMS = ['fastweb', 'fastweb.it']


class FastwebParser(BaseBollettaParser):
    NAME = "fastweb"
    FORNITORE_DISPLAY = "Fastweb"
    TIPO = "telefonia"
