"""Parser Iren — bollette Iren Mercato formato standard 2024-2026."""
...
_MATCH_TERMS = ['iren mercato', 'iren.it', 'iren spa']


class IrenParser(BaseBollettaParser):
    NAME = "iren"
    FORNITORE_DISPLAY = "Iren Mercato"
    TIPO = "gas"
