"""Parser A2a — bollette A2A Energia formato standard 2024-2026."""
...
_MATCH_TERMS = ['a2a energia', 'a2a.it', 'a2a']


class A2AParser(BaseBollettaParser):
    NAME = "a2a"
    FORNITORE_DISPLAY = "A2A Energia"
    TIPO = "gas"
